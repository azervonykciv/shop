 							...
 							<div class="col-md-4">
 								...
 								<div class="product-description product-description-brd margin-bottom-30">
 									<div class="overflow-h margin-bottom-5">
 										<div class="pull-left">
 											<h4 class="title-price"><a href="shop-ui-inner.html"><?php echo $p->name;?></a></h4>
 											<span class="gender text-uppercase"><?php echo $p->description;?></span>
 											
 										</div>
 										<div class="product-price">
 											<span class="title-price">Rp <?php echo $p->price;?></span>
 										</div>
 									</div>
 								</div>
 							</div>
