...
<!-- Mirrored from html.templines.com/sokolcov/appbox/home-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2016 17:51:31 GMT -->
...
<head>
		...
		<link href="<?php echo base_url('assets/front/css/master.css');?>" rel="stylesheet">

		<!-- SWITCHER -->
		<link rel="stylesheet" id="switcher-css" type="text/css" href="<?php echo base_url('assets/front/plugins/switcher/css/switcher.css');?>" media="all" />
		<link rel="alternate stylesheet" type="text/css" href="<?php echo base_url('assets/front/plugins/switcher/css/color1.css');?>" title="color1" media="all" data-default-color="true" />
		<link rel="alternate stylesheet" type="text/css" href="<?php echo base_url('assets/front/plugins/switcher/css/color2.css');?>" title="color2" media="all" />
		<link rel="alternate stylesheet" type="text/css" href="<?php echo base_url('assets/front/plugins/switcher/css/color3.css');?>" title="color3" media="all" />
		<link rel="alternate stylesheet" type="text/css" href="<?php echo base_url('assets/front/plugins/switcher/css/color4.css');?>" title="color4" media="all" />
	...
	<body class="animated-css">
		...
		<div class="switcher-wrapper">	
			...
			<script src="<?php echo base_url('assets/front/plugins/switcher/js/bootstrap-select.js');?>"></script> 
			<script src="<?php echo base_url('assets/front/plugins/switcher/js/evol.colorpicker.min.js');?>" type="text/javascript"></script> 
			<script src="<?php echo base_url('assets/front/plugins/switcher/js/dmss.js');?>"></script>
		</div>
		<!-- End Switcher -->
		<header class="header pageRow paralax skew skew-bottom" style="background-image: url('<?php echo base_url('assets/front/media/paralax/1.jpg');?>">
							...
							<div class="col-lg-9 col-md-9 col-sm-6 col-xs-6">
								...
								<nav class="nav-container customBgColor">
									...
									<ul class="menu">
										...
										<li><a class="roboto whiteTxtColor" href="home-1.html">SUPPORT</a></li>
									</ul>
								</nav>
							</div>
						</div>
				...
				<div class="header-bottom row">
					<div class="col-lg-12">
						<div class="header-left">
							...
							<div class="video-conatiner">
								<a class="video-image playVideo" href="http://www.youtube.com/watch?v=_NIsv0aHbOw" data-toggle="lightbox" data-title="Intro Video">
									<img src="<?php echo base_url('assets/front/media/home/6.jpg');?>" alt="Video">
						...
						<div class="header-right">
							<img class="wow fadeInRight" data-wow-delay="3.3s" src="<?php echo base_url('assets/front/media/home/1.png');?>" alt="Phones">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearfix">
						<div id="owl-screenshots" class="owl-carousel phone-slider">
							<div class="screenshot-item wow fadeInLeft" data-wow-delay="0.3s">
								<img src="<?php echo base_url('assets/front/media/260x455/1.jpg');?>" alt="Screenshot">
							</div>
							<div class="screenshot-item wow fadeInUp" data-wow-delay="0.3s">
								<img src="<?php echo base_url('assets/front/media/260x455/2.jpg');?>" alt="Screenshot">
							</div>
							<div class="screenshot-item wow fadeInRight" data-wow-delay="0.3s">
								<img src="<?php echo base_url('assets/front/media/260x455/3.jpg');?>" alt="Screenshot">
							</div>
		...
		<section id="moreApps" class="pageRow full-width-slider-controls paralax skew skew-bottom customBgColor trianglifyBox">
			<div class="wrapper">
				<div class="moreAppsBox row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 staticBox clearfix">
						<h3 class="sectionTitle white text-center ralewayLight">Our Products</h3>
								...
								<div class="">
									...
									<div class="preview-item_body">
										<h4 class="preview-item_title">
											<a href="app-details.html" class="ralewaySemiBold blackTxtColor">
												<?php echo $p->name ;?>
											</a>
										</h4>
										<div class="preview-item_pricebox clear">
											<span class="preview-item_price robotoCondensed blackTxtColor">
											<?php echo $p->price." Rupiah" ;?>
											</span>
										</div>
						...
						<div id="owl-members" class="owl-carousel white-control member-full-width staticBox">
							<div class="member-item center-block">
								<div class="member-ava circleBox center-block wow rotateIn" data-wow-delay="0.3s">
									<img src="<?php echo base_url('assets/front/media/124x124/1.png');?>" alt="Member">
								</div>
							...
							<div class="member-item center-block">
								<div class="member-ava circleBox center-block wow rotateIn" data-wow-delay="0.3s">
									<img src="<?php echo base_url('assets/front/media/124x124/2.png');?>" alt="Member">
								</div>
							...
							<div class="member-item center-block">
								<div class="member-ava circleBox center-block wow rotateIn" data-wow-delay="0.3s">
									<img src="<?php echo base_url('assets/front/media/124x124/3.png');?>" alt="Member">
								</div>
							...
							<div class="member-item center-block">
								<div class="member-ava circleBox center-block wow rotateIn" data-wow-delay="0.3s">
									<img src="<?php echo base_url('assets/front/media/124x124/4.png');?>" alt="Member">
								</div>
							...
							<div class="member-item center-block">
								<div class="member-ava circleBox center-block wow rotateIn" data-wow-delay="0.3s">
									<img src="<?php echo base_url('assets/front/media/124x124/5.png');?>" alt="Member">
								</div>
							...
							<div class="member-item center-block">
								<div class="member-ava circleBox center-block wow rotateIn" data-wow-delay="0.3s">
									<img src="<?php echo base_url('assets/front/media/124x124/6.png');?>" alt="Member">
								</div>
				...
				<div class="featuredBox row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearfix">
						...
						<ul class="featured-list">
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/1.png');?>" alt="Logo 1"></li>
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/2.png');?>" alt="Logo 2"></li>
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/3.png');?>" alt="Logo 3"></li>
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/4.png');?>" alt="Logo 4"></li>
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/5.png');?>" alt="Logo 5"></li>
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/6.png');?>" alt="Logo 6"></li>
							<li><img class="wow zoomIn" data-wow-delay="0.3s" src="<?php echo base_url('assets/front/media/featured/7.png');?>" alt="Logo 7"></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<footer id="footer" class="pageRow skew skew-top customBgColor">
			...
			<div class="wrapper">
				<div class="footerBox row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearfix">
						<a href=".html" class="footer-logo center-block wow bounceIn" data-wow-delay="0.3s">
							<img  src="<?php echo base_url('assets/front/img/footer-logo.png');?>" alt="Logo">
						</a>
						<div class="copyrightTxt robotoLight whiteTxtColor text-center wow bounceIn" data-wow-delay="0.3s">Copyright &copy; 2015. Designed by Templines</div>
		...
		<script src="<?php echo base_url('assets/front/js/jquery.placeholder.min.js');?>"></script>
		...
		<!-- Loader -->
		<script src="<?php echo base_url('assets/front/plugins/loader/js/classie.js');?>"></script>
		<script src="<?php echo base_url('assets/front/plugins/loader/js/pathLoader.js');?>"></script>
		<script src="<?php echo base_url('assets/front/plugins/loader/js/main.js');?>"></script>
		<script src="<?php echo base_url('assets/front/js/classie.js');?>"></script>
		<!--Owl Carousel-->
	    <script src="<?php echo base_url('assets/front/plugins/owl-carousel/owl.carousel.min.js');?>"></script>
	    <!--Ekko Lightbox-->
	    <script src="<?php echo base_url('assets/front/plugins/ekko-lightbox/ekko-lightbox.min.js');?>"></script>
        <!--Contact form--> 
        <script src="<?php echo base_url('assets/front/plugins/contact/jqBootstrapValidation.js');?>"></script> 
        <script src="<?php echo base_url('assets/front/plugins/contact/contact_me.js');?>"></script>
		<!--THEME--> 
		<script src="<?php echo base_url('assets/front/js/wow.min.js');?>"></script>
		<script src="<?php echo base_url('assets/front/js/cssua.min.js');?>"></script>
        <script src="<?php echo base_url('assets/front/js/func.js');?>"></script> 
	</body>

<!-- Mirrored from html.templines.com/sokolcov/appbox/home-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2016 17:52:44 GMT -->
</html>