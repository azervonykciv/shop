        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-5 center-block">
                    <?php echo form_open('front/pack_store/2','id="cta-signup-form" class="cta-signup-form"') ?>
                    ...
                    <div class="form-group">
                        <input  type="text" name="paket" value="Premium" class="contact-name form-control input-lg" placeholder="Premium"  disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input  type="text" name="jml" class="contact-name form-control input-lg" placeholder="Jumlah barang">
                    </div>
