            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form action="<?php echo base_url(); ?>User/updateUser" method="POST">
                        ...
                        <div class="input-group">
                            <label>Status</label>
                            <input name="Status" value="<?php echo $user1[0]->Status; ?>" type="text" class="form-control" readonly >
                        </div>
                        <div class="input-group">
                            <input class="btn btn-primary btn-submit" type="submit" value="Update"> &nbsp;
                            <a href="<?php echo base_url(); ?>User/resetPassword/<?php echo $user1[0]->ID_User; ?>/<?php echo $user1[0]->Status; ?>/<?php echo $id_user; ?>" class="btn btn-danger btn-submit">Reset Password </a>
                        </div>
                    </form>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
