            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Nama User</div>
                        <div class="panel-body"><?php echo $profile->Nama_User ?></div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">API KEY</div>
                        <div class="panel-body"><?php echo $profile->Tokenize ?></div>
                    </div>
                        ...
                        <table class="table table-bordered table-striped"">
                            ...
                            <tr>
                                ...
                                <td><?php echo $pack->Package ?></td>
                                <td><?php echo $pack->url ?></td>
